...
For more details and examples how to interact with Record and Collection models programmatically you could also check [Collection operations](./js-collections.md) and [Record operations](./js-records.md) sections.
...
[Prev: Routing](./js-routing.md) [Next: Record operations](./js-records.md)